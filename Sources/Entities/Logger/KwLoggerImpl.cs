...
namespace Grayscale.Kifuwarakaku.Entities.Logger
{
    ...
    public class KwLoggerImpl : ILogger
    {
        ...
        /// ファイル名
        /// </summary>
        public string FileStem { get { return this.fileNameWoe; } }
        ...
        /// タイムスタンプ出力の有無。
        /// </summary>
        public bool TimeStampPrintable { get { return this.print_TimeStamp; } }
        ...
        {
            bool enable = this.Enabled;
            bool printTimestamp = this.TimeStampPrintable;
            string filepath2 = Path.Combine(Application.StartupPath, this.FileName);
        ...
        {
            bool enable = this.Enabled;
            bool print_TimeStamp = this.TimeStampPrintable;
            string filepath2 = Path.Combine(Application.StartupPath, this.FileName);
