...
namespace Grayscale.P258UtilSky258.L500UtilSky
{
    ...
    public abstract class Util_Sky_FingersQueryEx
    {
        ...
        /// <param name="km"></param>
        /// <returns></returns>
        public static void Fingers_EachSrcNow(out Fingers out_fingers, SySet<SyElement> srcList, SkyConst src_Sky, Playerside pside, Starlight itaru, IKwErrorHandler errH)
        {
