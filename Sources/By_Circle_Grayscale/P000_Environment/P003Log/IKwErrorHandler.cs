...
namespace Grayscale.P003Log.I500Struct
{
    ...
    public delegate void DLGTOnLogAppend(string log);
    public delegate void DLGTOnLogClear();

    /// <summary>
    /// エラーの対応はお任せ、エラーハンドラー☆！
    /// </summary>
    public interface IKwErrorHandler
    {

        /// <summary>
        /// ロガー。
        /// </summary>
        IKwLogger Logger { get; }

        /// <summary>
        /// 用途は任意のイベント・ハンドラー＜その１＞。主にフォームにログ出力するのに使う。任意に着脱可。
        /// </summary>
        DLGTOnLogAppend DlgtOnLog1AppendOrNull { get; set; }
        DLGTOnLogClear DlgtOnLog1ClearOrNull { get; set; }
